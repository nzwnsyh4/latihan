...
<fieldset><legend>Registrasi</legend>
...
<label for="password2"><span>Konfirmasi Password: <span class="required"></span></span><input type="password" class="input-field" id="password2" name="password2" value="" /></label><br>
<label><span> </span><input type="submit" name="register"/></label>
</fieldset></center>
</body>
</html>